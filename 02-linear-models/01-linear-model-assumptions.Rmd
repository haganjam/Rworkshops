...
sum(b1_vec)
```
Interestingly, despite violating these assumptions, the calculated confidence intervals for the $b_0$ parameter contained the true population-level $\beta_0$ parameter in 955 out of the 1000 simulated studies (i.e. close to 95%). However, for the $b_1$ parameter, it was only 903 which means that the 95% confidence intervals we calculated are not valid. Rather, they are actually 90% confidence intervals (903/1000).
